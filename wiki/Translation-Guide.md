...
```bash
bench --site dev.localhost get-untranslated ar --app notifypro
```

### 2. Translation file format — تنسيق ملف الترجمة

File: `notifypro/translations/ar.csv`
...
bench --site dev.localhost get-untranslated ar --app notifypro | wc -l
```
...
2. Edit/create the CSV file in `notifypro/translations/`
